...
This package only guarantees the compatibility with the [version $new_version of MeiliSearch](https://github.com/meilisearch/MeiliSearch/releases/tag/$new_version).
